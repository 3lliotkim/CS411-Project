...
class SpotifyClient:
    ...
    def get_track_recommendations(self, seed_tracks, limit=50):
        """Get a list of recommended tracks starting from a seed track.
        :param seed_track (list of Track): Reference track to get recommendations. 
        ...
        url = f"https://api.spotify.com/v1/recommendations?seed_track={seed_track_url}"
